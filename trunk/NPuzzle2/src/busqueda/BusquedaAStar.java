...
public class BusquedaAStar{
	...
	public BusquedaAStar(String [][] estadoFinal,String [][]estadoInicial){
	...
	private String [][] copiar(String[][] a,String[][] b){
        ...
        /**
         * Calcula la distancia de Hamming (Casillas fuera de lugar)
         * 
         * @param tablero desordenado
         * @return distancia de Hamming
         */
        public int hamming( String[][] board )
        {
         ...
         */
        public int manhattan( String[][] board ){
            int aux;
            int valor = 0;
